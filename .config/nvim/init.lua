...
vim.api.nvim_create_autocmd('VimEnter', {
  desc = 'Open Neo-tree automatically when starting Neovim with a directory',
...
vim.keymap.set('n', '<C-k>', '<C-w><C-k>', { desc = 'Move focus to the upper window' })
  ...
  },
  {
    ...
    version = '1.*',
    dependencies = {
      { 'L3MON4D3/LuaSnip', version = '2.*', build = vim.fn.has 'win32' == 1 and nil or 'make install_jsregexp' },
      'folke/lazydev.nvim',
    },
    opts = {
  ...
  },
  {
    ...
    config = function()
      ...
      local ok_ui, dapui = pcall(require, 'nvim-dap-ui')
      if not ok_ui then
        return
      end
      dapui.setup()
  ...
  },
  {
    ...
    main = 'ibl',
    opts = { indent = { char = '┊' }, scope = { enabled = true, show_start = true, show_end = true } },
  },
  {
    'windwp/nvim-autopairs',
    event = 'InsertEnter',
    opts = { check_ts = true, ts_config = { lua = { 'string', 'source' }, javascript = { 'string', 'template_string' } } },
  },
  {
